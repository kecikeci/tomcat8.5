...
A:hover { COLOR: #088ce8}
body,td,span { font-size: 9pt}
.input  { BACKGROUND-COLOR: #ffffff;BORDER:#088ce8 1px solid;FONT-SIZE: 9pt}
.backc  { BACKGROUND-COLOR: #088ce8;BORDER:#088ce8 1px solid;FONT-SIZE: 9pt;color:white}
.PicBar { background-color: #088ce8; border: 1px solid #000000; height: 12px;}
...
<CENTER>
  <table width="760" border="0" cellpadding="0" cellspacing="0">
    <tr> 
      <td width="38%"><P style="MARGIN-TOP: 0px; MARGIN-BOTTOM: -8px">&nbsp;<STRONG 
      style="FONT-SIZE: 30pt">八哥JSP探针</STRONG></td>
      <td width="62%" align="center"><font color=red>欢迎访问<a href="http://www.8get.cn/">八哥高级java开发</a>，下载最新版程序<br>
      <a href="http://www.8get.cn/service/43/">直接下载最新版本</font></a></td>
    </tr>
  </table>  
...
| <a href="#ISpeedTest">服务器连接速度</a> 
  ...
  <tr> 
    <td height="22" align="center" bgcolor="#088ce8" onclick="showsubmenu(0)"><font color=#FFFFFF><strong>服务器相关参数</strong></font> 
...
<a href="#top" title="返回顶部"><font face='Webdings' color=#FFFFFF>5</font></a> <span id=txt0 name=txt0><a href='#' title='关闭此项'><font face='Wingdings' color=#FFFFFF>x</font></a></span> 
  ...
  <tr> 
    <td style="display" id='submenu0'><table border=0 width=100% cellspacing=1 cellpadding=3 bgcolor="#088ce8">
...
<table border="0" cellpadding="0" cellspacing="1" class="tableBorder">
  <tr> 
      <td height="22" align="center" bgcolor="#088ce8" onclick="showsubmenu(1)"><font color=#FFFFFF><strong>JAVA相关参数</strong></font> 
  ...
  <tr> 
    <td style="display" id='submenu1'>
		<table border=0 width=100% cellspacing=1 cellpadding=3 bgcolor="#088ce8">
          <tr bgcolor="#71dfff" height="22"> 
            <td width="30%">&nbsp;名称</td>
  ...
  <table border="0" cellpadding="0" cellspacing="1" class="tableBorder">
    <tr> 
      <td height="22" align="center" bgcolor="#088ce8" onclick="showsubmenu(2)"><font color=#FFFFFF><strong>参数查询</strong></font> 
        <a href="#top" title="返回顶部"><font face='Webdings' color=#FFFFFF>5</font></a> 
 ...
 <%
 	if(action.equals("query"))
	{
		...
		if(env.htShowMsg.size()>0)
			out.println("<tr bgcolor=\"#71dfff\" height=\"22\">\n<td>&nbsp;参数名称</td>\n<td>&nbsp;参数信息</td>\n</tr>");
		else
 ...
 %>
  ...
  <table border="0" cellpadding="0" cellspacing="1" class="tableBorder">
    <tr> 
      <td height="22" align="center" bgcolor="#088ce8" onclick="showsubmenu(3)"><font color=#FFFFFF><strong>服务器运算能力</strong></font> 
        <a href="#top" title="返回顶部"><font face='Webdings' color=#FFFFFF>5</font></a> 
        <span id=txt3 name=txt3><a href='#' title='关闭此项'><font face='Wingdings' color=#FFFFFF>x</font></a></span> 
      </td>
    </tr>
    <tr> 
      <td style="display" id='submenu3'> <table border=0 width=100% cellspacing=1 cellpadding=3 bgcolor="#088ce8">
          <tr bgcolor="#71dfff" height="22"> 
          ...
          <tr bgcolor="#FFFFFF" height="22"> 
            <td align=left>&nbsp;<a href="http://www.8get.cn" target="_blank">中国网聚服务器&nbsp; 
              (CPU:Intel Pentium III 1G 内存:768M)</a></td>
            <td align="center">20 毫秒</td>
            <td align="center">3 毫秒</td>
          </tr>
          <tr bgcolor="#FFFFFF" height="22"> 
            <td align=left>&nbsp;<a href="http://www.8get.cn" target="_blank">IBM俱乐部&nbsp; 
...
<%}%>
  ...
  <table border="0" cellpadding="0" cellspacing="1" bgcolor="#088ce8" class="tableBorder">
  <tr> 
    <td height="25" align="center" bgcolor="#088ce8" onclick="showsubmenu(4)"><font color="#FFFFFF"><strong>服务器连接速度</strong></font> 
...
<a href="#top" title="返回顶部"><font face='Webdings' color=#FFFFFF>5</font></a> <span id=txt4 name=txt4><a href='#' title='关闭此项'><font face='Wingdings' color=#FFFFFF>x</font></a></span> 
  ...
  <tr> 
    <td bgcolor="#F8F9FC" style="display" id='submenu4'> <table width="100%" border="0" cellspacing=1 cellpadding=3 bgcolor="#088ce8">
        <tr bgcolor="#FFFFFF"> 
          <td width="80">接入设备</td>
...
<table border=0 cellpadding=0 cellspacing=1 class=tableBorder>
  <tr>
    <td height="59" align=center>Copyright ? 2005-2016 , All Rights Reserved. 
<br>
欢迎访问★<a href="http://www.8get.cn/service/43/">八哥JSP探针</a>★，下载最新版程序<br>
	页面执行时间：约<%=timePageUse%>毫秒  8getJsp探针 V2016</td>
  </tr>
</table>
</CENTER>
</body>
